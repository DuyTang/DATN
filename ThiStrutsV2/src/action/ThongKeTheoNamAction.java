...
public class ThongKeTheoNamAction extends Action {
	@Override
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if ("Xem".equals(thongKeForm.getSubmit())) {
			...
			String so1 = orderBO.getSoLuongBanThoiGian12(thoiGian1);
			String so2 = orderBO.getSoLuongBanThoiGian12(thoiGian2);
