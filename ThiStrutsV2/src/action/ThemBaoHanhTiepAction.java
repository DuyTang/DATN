...
public class ThemBaoHanhTiepAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		BaoHanhForm baoHanhForm= (BaoHanhForm) form;
		 ...
		 String maSP = baoHanhForm.getIMEI();
		 baoHanhForm.setIMEI(maSP);
		 String lan = baoHanhBO.getLanBH(maSP);
		 baoHanhForm.setLanBaoHanh(lan);
	        ...
	        if("submit".equals(baoHanhForm.getSubmit())){
	            ...
	            return mapping.findForward("themTiepThanhCong");
	        }else{
	            return mapping.findForward("themTiep");
	        }    
	    }
