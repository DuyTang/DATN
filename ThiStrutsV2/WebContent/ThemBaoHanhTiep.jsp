...
<body>
	<div class="container">
		...
		<br>
		<html:form action="/themBH" method="post" styleId="form">
			...
			<div class="row form-group">
				...
				<div class="col-lg-3">
					<html:text property="lanBaoHanh" styleClass="form-control"
						readonly="true"></html:text>
				</div>
			</div>
			<div class="row form-group">
			...
			<div class="row form-group">
				...
				<div class="col-lg-3">
					<html:text property="IMEI" styleClass="form-control" readonly="true"></html:text>
					<p style="color: red">
