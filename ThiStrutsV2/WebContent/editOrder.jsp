...
<script>
	...
	function disable() {
		$(document).ready(function() {
			...
			$('#dateFormatPlaceHolder').attr("disabled", "");
		});
	};
...
<body>
	...
	<br/>
	<logic:equal name="orderForm" property="tinhTrangGiaoHang" value="0">
		Đơn hàng này đã giao, không thể chỉnh sửa
		<script>
			disable();
		</script>
	</logic:equal>
	...
	<html:form action="/editOrder">
		<table>
			...
			<tr>
				...
				<td><html:radio name="orderForm" property="tinhTrangGiaoHang"
						...
						name="orderForm" property="tinhTrangGiaoHang" value="0">Đã giao</html:radio>
				</td>
			</tr>
			<tr>
		...
		<logic:equal name="orderForm" property="tinhTrangGiaoHang" value="1">
