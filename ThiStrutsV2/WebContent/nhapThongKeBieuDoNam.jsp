...
<div class="container">
	...
	<div class="row">
		...
		<div class="clearfix visible-lg">
			...
			<html:form action="/thongKeBieuDoNam-soLuong" method="post">

				<label class="col-lg-2" style="width: 300px">Nhập Năm (YYYY)</label>
				<html:text property="nam" styleClass="form-control"
