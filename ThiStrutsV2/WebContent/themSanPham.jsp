...
<jsp:include page="header.jsp" />
				...
				<br>
				<html:form action="/themSP" method="post"
					...
					<div class="row form-group">
						...
						<html:file style="margin-left: 190px" property="anhSP" onchange="readURL(this);"></html:file>
						<div style="margin-left: 190px">
							<img id="blah" src="#" alt="your image" />
						</div>
						<span style="color: red">*</span>
						<html:errors property="common.anhSP" />
					</div>
					...
					<div class="row form-group">
						...
						<div class="col-lg-3">
							<html:select property="maLoai" styleClass="form-control">
								<html:optionsCollection name="sanPhamForm"
									property="arrLoaiSanPham" label="tenLoai" value="maLoai" />
							</html:select>
						</div>
					</div>
					...
					<div class="row form-group">
						<div class="col-lg-3 col-lg-offset-2">
							...
							<html:link styleClass="btn btn-primary" action="/quanLySanPham.do?soTrang=1">Hủy</html:link>
						</div>
					</div>
				</html:form>
				<!-- /.nội dung code:  -->
